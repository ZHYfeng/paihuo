...
import { CirclePlus, Layers, Copy, Pause, Play, Send, Square, Trash2, Truck } from "lucide-react";
...
export function SessionDetailPage() {
  ...
  return <>
    ...
    {item.status === "active" && <form className="sticky bottom-4 mt-3 flex gap-3 rounded-xl border border-line bg-surface/95 p-3 shadow-pop backdrop-blur" onSubmit={e => { e.preventDefault(); send(); }}>
